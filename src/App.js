...
export default function App() {
  ...
  return (
    <div className="fixed inset-0 h-[100dvh] bg-[#020202] text-white font-sans overflow-hidden transition-colors duration-1000 select-none flex">
      ...
      {/* Desktop Sidebar */}
      <aside className="w-64 bg-black/60 backdrop-blur-3xl p-6 hidden lg:flex flex-col border-r border-white/5 z-30 relative shrink-0">
        <SidebarContent />
      </aside>
      ...
      <div className="flex-1 flex flex-col relative min-w-0 h-full overflow-hidden">
        ...
        {/* Header - Z-index high and shrink-0 to prevent overlap */}
        <header className="shrink-0 pt-4 px-6 lg:pt-8 lg:px-12 z-40 relative bg-gradient-to-b from-black/80 to-transparent">
        ...
        {/* Carousel Area - pt-16/pt-24 for vertical separation from header */}
        <main className="flex-1 relative z-10 overflow-hidden flex flex-col justify-center pt-16 lg:pt-24 pb-32">
          <div 
            ref={scrollContainerRef}
            className="flex gap-6 lg:gap-10 px-10 lg:px-40 overflow-x-auto no-scrollbar scroll-smooth snap-x snap-mandatory items-center"
          >
            {filteredTracks.map(track => {
              ...
              return (
                <div 
                  ...
                  className="flex-none w-48 sm:w-56 lg:w-64 snap-center group/card cursor-pointer relative"
                >
            ...
            <div className="flex-none w-48 sm:w-56 lg:w-64" />
          </div>
        </main>
      </div>
